...
import { PasskeyButton } from "~/app/(my-app)/dashboard/account/settings/passkey-button";
import { SettingsForm } from "~/app/(my-app)/dashboard/account/settings/settings-form";
